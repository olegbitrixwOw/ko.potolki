...
class SelectSiteStep extends CSelectSiteWizardStep
{
	function InitStep()
	{
		...
		$wizard->solutionName = "ko.potolki";
	}
}
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		$siteLogo = $this->GetFileContentImgSrc(WIZARD_SITE_PATH."include/company_name.php", "/bitrix/wizards/ko/potolki/site/templates/potolki_by_ko/themes/".$themeID."/lang/".LANGUAGE_ID."/logo.png");
		if (!file_exists(WIZARD_SITE_PATH."include/logo.png"))
			$siteLogo = "/bitrix/wizards/ko/potolki/site/templates/potolki_by_ko/themes/".$themeID."/lang/".LANGUAGE_ID."/logo.png";
		...
		$wizard->SetDefaultVars(
			...
			//	"siteBanner" => $siteBanner, 
				...
				"siteSlogan" => $this->GetFileContent(WIZARD_SITE_PATH."include/header_title.php", GetMessage("WIZ_COMPANY_SLOGAN_DEF")),
				"phoneHeader1" => $this->GetFileContent(WIZARD_SITE_PATH."include/phone1.php", GetMessage("WIZ_PHONE1_DEF")),
