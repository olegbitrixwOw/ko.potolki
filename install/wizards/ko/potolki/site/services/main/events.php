...
$em = new CEventMessage;
		...
		$tempSubj = "Вызов мастера с  сайта #SITE_NAME#";
		$tempText = "Вызов мастера с сайта #SITE_NAME#<br>
------------------------------------------<br>
<br>
На сайте была оставлена заявка на Вызов мастера<br>
<br>
Имя: #AUTHOR#<br>
Номер телефона: #AUTHOR_EMAIL#<br>
<br>
...
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/templates/".WIZARD_TEMPLATE_ID."_".WIZARD_THEME_ID."/footer.php", array("VIZOV_MASTERA_ID" => $event_id));
